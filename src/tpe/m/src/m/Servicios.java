...
//        this.tareas = reader.readTasks(pathTareas);
		  ...
		  int limiteTareasCriticas = 2; // Define el límite de tareas críticas por procesador
	        int limiteTiempoNoRefrigerado = 110; // Define el límite de tiempo para procesadores no refrigerados
	        ...
	        List<Procesador> mejorAsignacion = asignadorGreedy.asginarGreedy(new ArrayList<>(procesadores.values()), new ArrayList<>(tareas.values()), limiteTareasCriticas, limiteTiempoNoRefrigerado);
	        	//System.out.println("las mejores asignaciones son: " +mejoresAsignaciones);
	        
	        System.out.println("La mejor asignacion es: "+mejorAsignacion);
	        System.out.println(asignadorGreedy.getTiempoFinal());
